...
RUBRIC = [
          ("Exercise 1: Empty library", "empty_library", 2.0),
          ("Exercise 2: Verify number of books", "verify_num_books", 6.0),  
          ("Exercise 3: Add book", "add_book", 14.0),
          ("Exercise 4: Remove book", "remove_book", 14.0), 
          ("Exercise 5: Books by year", "books_by_year", 14.0),  
          ("Exercise 6: Flip through books", "flip_through_books", 10.0)
         ]
